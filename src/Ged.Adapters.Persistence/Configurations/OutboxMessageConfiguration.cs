...
internal sealed class OutboxMessageConfiguration(IPersistenceProvider provider)
    : IEntityTypeConfiguration<OutboxMessage>
{
    public void Configure(EntityTypeBuilder<OutboxMessage> builder)
    {
        ...
        builder.Property(m => m.Payload).HasColumnName("payload").HasColumnType(provider.JsonColumnType);
